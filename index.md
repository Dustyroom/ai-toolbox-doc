...
header:
  ...
  actions:
    - label: "Get on Unity Asset Store"
      ...
      excerpt: "ChatGPT, DALL•E, Whisper, Google Gemini and more inside your Unity project."
...
feature_runtime:
  - image_path: /assets/images/landing/landing_icon_dialogue.svg
    ...
    excerpt: '**Securely use ChatGPT and DALL•E in games.** Generate NPC dialogue, town names, item descriptions, icons and more.'
    url: "/chatgpt-runtime/"
    btn_label: "Read More"
    btn_class: "btn--primary"
