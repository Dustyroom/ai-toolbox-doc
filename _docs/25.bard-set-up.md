...
The setup process for *Bard* is a more complicated than for *ChatGPT*, since *Bard* is not a standalone service, but a part of *Google Cloud*, which needs to be configured as well.
{:.notice--info}
