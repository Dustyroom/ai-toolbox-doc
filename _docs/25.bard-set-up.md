...
- [PaLM 2](https://ai.google/discover/palm2/){:target="_blank"}. PaLM 2 is the default Bard model, which is free and offers a good balance between quality and cost.
- [Gemini Pro](https://blog.google/technology/ai/google-gemini-ai/#introducing-gemini){:target="_blank"}. It is available for all Editor tasks, including code generation and freeform chat. In our tests Gemini produced outstanding results for Unity-related topics. Plus, it's super cheap and includes a $300 free credits.
