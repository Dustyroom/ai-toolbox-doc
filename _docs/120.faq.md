...
For Generating scripts and images, edititing the scripts and freeform chat you can change the backend in the _Settings_ foldout menu of each of the respective windows.  
![](../assets/images/manual_images/sg-change-backend-generate-script.gif){: .image-rounded }
---
