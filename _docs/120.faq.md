...
Additionally, if there is a particular script you know it should use, you can attach it for context in the [freeform chat](/getting-started/#chat-with-ai) window.
