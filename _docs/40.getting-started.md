...
Please note that the outcome of the generation process completely depends on the GPT generation abilities.
{:.notice--warning}
...
![Shader generate menu item, method 1](/assets/images/manual_images/gpt-shader-generate-menu-item-method-1.png)
</a>
...
![Shader generate menu item, method 2](/assets/images/manual_images/gpt-shader-generate-menu-item-method-2.png)
</a>
...
- **Open File** - This will open the generated shader file in the default application for the file type. Shortcut: `Ctrl/Cmd + Enter`.
