...
You can set up Ollama here to be able to use its various models in the generation and chat processes. The detailed step-by-step guide on the Ollama setup is [here](/llm-set-up/).
...
{:.image-caption}
Ollama set up settings settings
