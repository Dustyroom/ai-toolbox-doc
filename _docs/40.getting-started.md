...
Once selected a script file to edit and clicked **Edit C# Script with ChatGPT**, the prompt window will have the **Overwrite _Script_** parameter. Enable this option to overwrite the previous script.

![Editing the generated script in the prompt window](/assets/images/manual_images/sg-prompt-window-editing.png){: .image-simple }

{:.image-caption}
Editing the generated script in the prompt window
