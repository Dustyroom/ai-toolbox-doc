...
To generate a script with ChatGPT, Gemini, Ollama, Claude etc, you'll need to open the prompt window. There are two ways to do this:
...
<a href="/assets/images/manual_images/sg-project-settings-apikey-claude-cropped.png">
![Claude API Key and other settings](/assets/images/manual_images/sg-project-settings-apikey-claude-cropped.png)
</a>
