...
With {{ site.title_short }}, you can chat with **ChatGPT** and **Google Bard** within Unity. You can ask AI to explain the code, ask it how to do operations in Unity etc. If it outputs any piece of code, you have an option to save it as a file in the project.
...
You can use Google Bard AI model to generate scripts and chat with AI usin this GPT. The detailed step-by-step guide on the Google Bard setup is located on the settings panel.
