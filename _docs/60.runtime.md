...
```
public static Action QuickRequest(string prompt, Parameters parameters, Action<string> completeCallback,
...
```
public static Action StreamRequest(string prompt, Parameters parameters, Action<string> updateCallback,
