...
Sends a request to ChatGPT and receives the response.

Depending on the `updateCallback` parameter, the response can be received either all at once or in chunks as it is generated.
