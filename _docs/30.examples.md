---
title: "Examples of using AI Script Generator"
permalink: /examples/
excerpt: "Example prompts for AI Script Generator"
---

## Overview

This page contains a few examples of the use cases for AI Script Generator. These are not the only use cases but rather just hints to what you can prompt and how you can phrase your prompts.

## Example C# Scripts

### Example Script 1
This is a basic script, which was generated from a not very descriptive prompt. The script is not very complex, but it is a good starting point for a more complex script. In this case AI Script Generator also added a Unity's Component (_Nav Mesh Agent_) in addition to the _Waypoint Patrol_ script.
