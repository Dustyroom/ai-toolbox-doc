...
**New!** **Anthropic Claude** is now available in {{ site.title_short }}! You can now use Claude Sonnet 4.5 in Unity, one of the best tools for coding. Check out the [Claude](/claude-set-up/) page for more details.
{:.notice--success}
