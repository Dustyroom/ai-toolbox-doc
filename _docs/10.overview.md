...
**New!** We've added support for **Google Bard**. Now for any question or script you can use both ChatGPT and Bard! Check out [Bard Setup Guide](/bard-set-up/) for more details.
{:.notice--success}
