...
There may be several reasons for this. A few things to try:
- You can ask anything you like, but keep it clean and appropriate. Please have a look at this page for more details: [How To Write Prompts](/how-to-write-prompts/).
- Try to avoid very complex requests that require multiple steps to complete. Break them down into smaller parts and generate, then iterate little by little.
- It may be the opposite, the request you gave is too simple and vague. Please remember that specific doesn't mean short. It will work the best if you describe your request with at least several sentences covering all nuances of your request.
- The generation quality may vary between different AI models. If you are not satisfied with the results, try switching to another model or chatbot.
- It is advised that you use less pronouns like 'it' or 'they' and more nouns like 'the given model' or 'the character'.
...
#### I can't change the Chatbot in Chat with AI
If you have already chatted with any chatbot, it is not possible to change it if there are existing messages in the chat history. To change the chatbot, please clear the chat history first. You can do it by pressing the **Clear** button in the bottom-left corner of the _Chat with AI_ window.
