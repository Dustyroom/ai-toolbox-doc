...
Runtime Gemini usage is a new feature introduced in **{{site.title_short}} 6.4.0**. It allows you to use the Gemini API in your Unity project at runtime. This feature is useful for creating interactive applications, games, and other projects that require real-time communication with the Gemini API.
{:.notice--success}
