...
**Advanced Options** — if expanded, reveals the [_Temperature_](/how-to-use/#temperature) and [_History_](/how-to-use/#prompt-history) parameters, mirrored from the [**Settings panel**](/how-to-use/#chatgpt-script-generator-settings) (which can be found in _Edit_ ▶︎ _Project Settings_ ▶︎ _ChatGPT Script Generator_).
