...
- **OpenAI Documentation** opens the [OpenAI documentation](https://beta.openai.com/docs/developer-quickstart/1-introduction) in your browser.
...
- **Inspector button** toggles the _"Generate Component"_ button in the Inspector.
...
- **View History** shows the history of the prompts you have used to generate scripts in the current Unity project.
