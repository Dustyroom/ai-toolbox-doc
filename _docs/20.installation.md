...
* [Ollama](/ollama-set-up/).

## Welcome Scene

The _Welcome scene_ is a good place to check if your configuration is valid, also for some basic instructions how to start working with {{ site.title_short }}.
