...
We've just added the Ollama support. And we're working on this page, stay tuned! But the setup is pretty simple, just follow the instructions in the AI Toolbox Settings window (Edit → Project Settings → AI Toolbox → 'Ollama' tab).
