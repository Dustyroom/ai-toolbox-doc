...
excerpt: "How to make AI Toolbox work with local models"
---

![](../assets/images/landing/landing_icon_llm.svg){:.image-simple}

We're adding the LLM support in the following upadates. Stay tuned!
